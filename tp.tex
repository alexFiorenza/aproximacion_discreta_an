...
\usepackage[a4paper,top=3.0cm,bottom=2.5cm,left=2.5cm,right=2.5cm,headheight=38pt,headsep=0.65cm]{geometry}
\usepackage{setspace}
\onehalfspacing
...
\definecolor{utnred}{HTML}{C8102E}
\definecolor{utnbrown}{HTML}{24130E}
...
\newcommand{\utnlogo}{logo-utn-frba-1.png}
\newcommand{\linkPresentacion}{https://youtu.be/oGs5gnDfWcA?si=8vU9Bn-2B6IV6T6-}
\newcommand{\linkRepositorio}{https://github.com/alexFiorenza/aproximacion_discreta_an}
\newcommand{\enlaceRepositorio}{\href{\linkRepositorio}{\nolinkurl{\linkRepositorio}}}

\pagestyle{fancy}
\fancyhf{}
\lhead{\includegraphics[height=0.82cm]{\utnlogo}}
\chead{\small\textbf{Análisis Numérico}\\[-1mm]\scriptsize Aproximación discreta por mínimos cuadrados}
\rhead{\small UTN FRBA}
...
% ============================================================
% DATOS DEL TRABAJO Y CARÁTULA
% ============================================================

\newcommand{\tituloTrabajo}{Aproximación discreta por mínimos cuadrados}
\newcommand{\subtituloTrabajo}{Demanda prioritaria de gas natural en función de la temperatura media}
\newcommand{\asignatura}{Análisis Numérico}
\newcommand{\universidad}{Universidad Tecnológica Nacional}
...
\vspace*{0.2cm}
\includegraphics[width=0.74\textwidth]{\utnlogo}\par

\vspace{1.15cm}
{\color{utnred}\rule{0.92\textwidth}{1.2pt}}\par
\vspace{0.55cm}
...
\vspace{0.55cm}
{\color{utnred}\rule{0.68\textwidth}{0.8pt}}\par
...
\centering
\textbf{Presentación del trabajo práctico}\\[1mm]
\href{\linkPresentacion}{\nolinkurl{\linkPresentacion}}\\[3mm]
\textbf{Código fuente, datos y material complementario}\\[1mm]
\enlaceRepositorio
\end{tcolorbox}
...
{\small \universidad{} -- \facultad\par}
\end{titlepage}
}
...
\begin{importantbox}
\textbf{Presentación del trabajo práctico.} El material audiovisual asociado al informe se encuentra disponible en:\\
\href{\linkPresentacion}{\nolinkurl{\linkPresentacion}}
\end{importantbox}

\begin{importantbox}
\textbf{Repositorio del trabajo.} Los datos, tablas, figuras y material complementario de este informe están disponibles en:\\
\enlaceRepositorio
\end{importantbox}
...
\input{tables/datos_muestra.tex}
\end{table}
...
\label{tab:sumas-lineal}
\input{tables/sumas_lineal.tex}
\end{table}
...
\label{tab:sumas-cuadratico}
\input{tables/sumas_cuadratico.tex}
\end{table}
...
\label{tab:sumas-exponencial}
\input{tables/sumas_exponencial.tex}
\end{table}
...
\input{tables/estimacion_final.tex}
\end{table}
...
\begin{itemize}
    ...
    \item Fiorenza, A.; et al. \textit{Aproximación discreta por mínimos cuadrados} --- repositorio con código fuente, datos, tablas y figuras del trabajo práctico.\\
    \url{https://github.com/alexFiorenza/aproximacion_discreta_an}
\end{itemize}
